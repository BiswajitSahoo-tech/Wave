...
userRouter.get('/active/:id', userController.getActive)
userRouter.patch('/active', userController.updateActive)
userRouter.patch('/busy', userController.updateBusy)
userRouter.get('/busy/:id', userController.getBusy)
